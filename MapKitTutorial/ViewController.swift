...
class ViewController: UIViewController {
    ...
    weak var delegate: AddLocationTableViewControllerDelegate?
    ...
    @IBAction func SavedButton(_ sender: UIButton) {
        ...
        delegate?.SavedButton(by: self, with: lat, with: long)
    }
...
extension ViewController: HandleMapSearch {
    ...
    func dropPinZoomIn(_ placemark: MKPlacemark){
        ...
        latitude.append(annotation.coordinate.latitude)
        longitude.append(annotation.coordinate.longitude)
        mapView.setRegion(region, animated: true)
        print("the latitude is \(latitude[0])")
        print("the latitude is \(longitude[0])")
    }
